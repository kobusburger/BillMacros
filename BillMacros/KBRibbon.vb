...
Public Class KBRibbon
    ...
    Public Function GetCustomUI(ByVal ribbonID As String) As String Implements Office.IRibbonExtensibility.GetCustomUI
        Return GetResourceText("BillMacros.KBRibbon.xml")
    End Function
...
#Region "Ribbon Callbacks"
    ...
    Public Sub Ribbon_Load(ByVal ribbonUI As Office.IRibbonUI)
        Me.ribbon = ribbonUI
    End Sub
    Public Sub OnPageFormat(ByVal control As Office.IRibbonControl)
        PageFormat()
    End Sub
    Public Sub OnEditFormat(ByVal control As Office.IRibbonControl)
        EditFormat()
    End Sub
    Public Sub OnSetPage(ByVal control As Office.IRibbonControl)
        SetPage()
    End Sub
    Public Sub OnCreateSum(ByVal control As Office.IRibbonControl)
        CreateSum()
    End Sub
